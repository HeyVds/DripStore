    ...
    <section className="section-content-form">
      ...
      <div className="contentainer-form-pessoal">
        <div className="content-form-pessoal">
          ...
          <FormInput title="E-mail *" placeholder="Insira seu email" />
      ...
      <div className="termos">
        ...
        <p>
          ...
          Store. A frequência de envios pode variar de acordo com a interação do
          cliente.
        </p>
      </div>

      <div className="button-criar">
        <Button label="Criar conta" size="x-large" style="primary" />
      </div>
    </section>
  );
};
