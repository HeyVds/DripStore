      ...
      <div className="flex flex-row justify-between w-full items-center px-40 py-5">
        ...
        <div className="relative flex items-center w-full max-w-md">
          <input
            ...
            type="text"
            className="w-full px-4 py-2 pr-10 text-sm text-gray-700 bg-slate-300 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
